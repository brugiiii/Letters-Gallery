...
/* harmony default export */ __webpack_exports__["default"] = (updateBuyButton);

/***/ }),

/***/ "./assets/js/home/accordion.js":
/*!*************************************!*\
  !*** ./assets/js/home/accordion.js ***!
  \*************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _refs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./refs */ "./assets/js/home/refs.js");



function handleTitleClick(e) {
  var $this = $(e.currentTarget);
  var navWrapper = $this.closest(".gallery-nav");
  var siblingsNavWrappers = navWrapper.siblings(".gallery-nav");
  var siblingsNavLists = siblingsNavWrappers.find(".nav-list");
  $this.next().slideToggle(500);
  siblingsNavLists.slideUp(500);
  navWrapper.toggleClass("active");
  siblingsNavWrappers.removeClass("active");
}
_refs__WEBPACK_IMPORTED_MODULE_2__["default"].galleryNav.on("click", ".gallery__title", handleTitleClick);

/***/ }),

/***/ "./assets/js/home/activateCategory.js":
/*!********************************************!*\
  !*** ./assets/js/home/activateCategory.js ***!
  \********************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _refs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./refs */ "./assets/js/home/refs.js");


var artistsList = _refs__WEBPACK_IMPORTED_MODULE_1__["default"].artistsList;
var _settings = settings,
  home_url = _settings.home_url;
function handleButtonClick(e) {
  var $this = $(e.currentTarget);
  var catId = $this.data("artist-id");
  window.location.href = "".concat(home_url, "?artistId=").concat(catId);
}
artistsList.on("click", "button", handleButtonClick);

/***/ }),

/***/ "./assets/js/home/fetchProducts.js":
/*!*****************************************!*\
  !*** ./assets/js/home/fetchProducts.js ***!
  \*****************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _refs__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./refs */ "./assets/js/home/refs.js");
/* harmony import */ var _helpers_skeleton__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../helpers/skeleton */ "./assets/js/helpers/skeleton.js");
/* harmony import */ var _mobileFilterVisibility__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./mobileFilterVisibility */ "./assets/js/home/mobileFilterVisibility.js");
...
var productsWrapper = _refs__WEBPACK_IMPORTED_MODULE_6__["default"].productsWrapper,
  paginationWrapper = _refs__WEBPACK_IMPORTED_MODULE_6__["default"].paginationWrapper,
  galleryNav = _refs__WEBPACK_IMPORTED_MODULE_6__["default"].galleryNav,
  filterEl = _refs__WEBPACK_IMPORTED_MODULE_6__["default"].filterEl,
  clearAllButton = _refs__WEBPACK_IMPORTED_MODULE_6__["default"].clearAllButton,
  navListButtons = _refs__WEBPACK_IMPORTED_MODULE_6__["default"].navListButtons;
var query = {
...
function fetchProducts() {
  var skeleton = (0,_helpers_skeleton__WEBPACK_IMPORTED_MODULE_7__.productsSkeleton)();
...
function renderProducts(res) {
  var _JSON$parse = JSON.parse(res),
    ...
    pagination = _JSON$parse.pagination;
...
function handleNavClick(e) {
  var $this = $(e.currentTarget);
  var taxSlug = $this.data("tax-slug");
  var taxId = $this.data("tax-id");
  if ($this.hasClass("active")) {
    var taxIndex = query.taxObjects.findIndex(function (obj) {
      return obj.id === taxId;
    });
...
function handleFilterClick(e) {
  ...
  query.taxObjects.splice(taxIndex, 1);
  $(".nav-list__button.active[data-tax-id=\"".concat(taxId, "\"")).removeClass("active");
  setTimeout(function () {
    $this.remove();
  }, 0);
  query.page = 1;
...
function renderFilterButtons() {
  var buttonsMarkup = query.taxObjects.map(function (term) {
    return "\n    <button data-tax-id=\"".concat(term.id, "\"><span>").concat(term.text, "</span></button>");
  }).join('');
  filterEl.html(buttonsMarkup);
  if (window.innerWidth < 1025) {
    (0,_mobileFilterVisibility__WEBPACK_IMPORTED_MODULE_8__.hideFilter)();
    (0,_mobileFilterVisibility__WEBPACK_IMPORTED_MODULE_8__.handleButtonClick)();
  }
}
...
/***/ "./assets/js/home/isScrollActive.js":
/*!******************************************!*\
  !*** ./assets/js/home/isScrollActive.js ***!
  \******************************************/
/***/ (function() {
...
$(document).ready(function () {
  var container = $('.gallery-nav-inner');
...
/***/ "./assets/js/home/manipulateCart.js":
/*!******************************************!*\
  !*** ./assets/js/home/manipulateCart.js ***!
  \******************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _refs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./refs */ "./assets/js/home/refs.js");
/* harmony import */ var _helpers_updateBuyButton__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../helpers/updateBuyButton */ "./assets/js/helpers/updateBuyButton.js");


var accessoriesWrapper = _refs__WEBPACK_IMPORTED_MODULE_0__["default"].accessoriesWrapper,
  productsWrapper = _refs__WEBPACK_IMPORTED_MODULE_0__["default"].productsWrapper,
  buyButton = _refs__WEBPACK_IMPORTED_MODULE_0__["default"].buyButton,
  itemCountEl = _refs__WEBPACK_IMPORTED_MODULE_0__["default"].itemCountEl,
  basketWrapper = _refs__WEBPACK_IMPORTED_MODULE_0__["default"].basketWrapper;
var _settings = settings,
  ajax_url = _settings.ajax_url;
function manipulateCart(e) {
  var $this = $(e.currentTarget);
  var productId = $this.data("id");
  var cartAction = $this.data("action");
  var closestCard = $this.closest(".products__item");
  var productsBuyButtons = $(".products__buy");
  var query = {
  ...
  $.ajax({
    ...
    success: function success(res) {
      return handleResponse($this, cartAction, closestCard, productsBuyButtons, res);
    },
    error: function error(_error) {
      return console.log(_error);
    }
...
function handleResponse($this, cartAction, closestCard, productsBuyButtons, res) {
  var _res$data = res.data,
    basketMarkup = _res$data.basketMarkup,
    cartCount = _res$data.cartCount,
    cartButtonMarkup = _res$data.cartButtonMarkup;
  var cartButton = $(".cart-button");
  (0,_helpers_updateBuyButton__WEBPACK_IMPORTED_MODULE_1__["default"])(cartAction, $this);
...
/***/ "./assets/js/home/mobileFilterVisibility.js":
/*!**************************************************!*\
  !*** ./assets/js/home/mobileFilterVisibility.js ***!
  \**************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   handleButtonClick: function() { return /* binding */ handleButtonClick; },
/* harmony export */   hideFilter: function() { return /* binding */ hideFilter; }
/* harmony export */ });
/* harmony import */ var _refs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./refs */ "./assets/js/home/refs.js");

var mobileFilterButton = _refs__WEBPACK_IMPORTED_MODULE_0__["default"].mobileFilterButton,
  closeFilter = _refs__WEBPACK_IMPORTED_MODULE_0__["default"].closeFilter;
...
var aboutButton = _refs__WEBPACK_IMPORTED_MODULE_0__["default"].aboutButton,
  aboutTextItem = _refs__WEBPACK_IMPORTED_MODULE_0__["default"].aboutTextItem,
  artistsListWrapper = _refs__WEBPACK_IMPORTED_MODULE_0__["default"].artistsListWrapper,
  artistsButton = _refs__WEBPACK_IMPORTED_MODULE_0__["default"].artistsButton;
...
/*!***************************!*\
  ...
  \***************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _home_heroSwiper__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./home/heroSwiper */ "./assets/js/home/heroSwiper.js");
/* harmony import */ var _home_fetchProducts__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./home/fetchProducts */ "./assets/js/home/fetchProducts.js");
/* harmony import */ var _home_manipulateCart__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./home/manipulateCart */ "./assets/js/home/manipulateCart.js");
/* harmony import */ var _home_activateCategory__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./home/activateCategory */ "./assets/js/home/activateCategory.js");
/* harmony import */ var _home_showMore__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./home/showMore */ "./assets/js/home/showMore.js");
/* harmony import */ var _home_isScrollActive__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./home/isScrollActive */ "./assets/js/home/isScrollActive.js");
/* harmony import */ var _home_isScrollActive__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_home_isScrollActive__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var _home_mobileFilterVisibility__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./home/mobileFilterVisibility */ "./assets/js/home/mobileFilterVisibility.js");
/* harmony import */ var _home_accordion__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./home/accordion */ "./assets/js/home/accordion.js");
/* harmony import */ var _css_home_scss__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../css/home.scss */ "./assets/css/home.scss");
