...
/***/ "./assets/js/basket/manipulations.js":
/*!*******************************************!*\
  !*** ./assets/js/basket/manipulations.js ***!
  \*******************************************/
...
/* harmony import */ var _refs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./refs */ "./assets/js/basket/refs.js");
/* harmony import */ var _helpers_updateBuyButton__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../helpers/updateBuyButton */ "./assets/js/helpers/updateBuyButton.js");





var basketWrapper = _refs__WEBPACK_IMPORTED_MODULE_3__["default"].basketWrapper,
  itemCountEl = _refs__WEBPACK_IMPORTED_MODULE_3__["default"].itemCountEl,
  cartButton = _refs__WEBPACK_IMPORTED_MODULE_3__["default"].cartButton,
  cardButtonPrice = _refs__WEBPACK_IMPORTED_MODULE_3__["default"].cardButtonPrice,
  cartCountEl = _refs__WEBPACK_IMPORTED_MODULE_3__["default"].cartCountEl;
var _settings = settings,
  ajax_url = _settings.ajax_url;
function updateQuantity(e) {
  var $this = $(e.currentTarget);
  var counterValueEl = $this.closest(".counter").find(".counter__value");
  var counterValue = Number(counterValueEl.text());
  ...
  updateQuantity.debounceTimer = setTimeout(function () {
    var productId = $this.data("product-id");
    var quantity = Number(counterValueEl.text());
    updateProductQuantity(productId, quantity, $this);
  }, 300);
}
function updateProductQuantity(productId, quantity, $this) {
  var closestCard = $this.closest(".basket-products__item");
  var query = {
  ...
  $.ajax({
    ...
    success: function success(res) {
      var _res$data = res.data,
        productPrice = _res$data.productPrice,
        productsPrice = _res$data.productsPrice,
        totalPrice = _res$data.totalPrice,
        cartCount = _res$data.cartCount;
      var priceEl = $(".basket-price[data-id=\"".concat(productId, "\"]"));
      var summaryItem = $(".summary-item span:last-child");
      var summaryTotal = $(".summary-total span:last-child");
  ...
  $.ajax({
    ...
    success: function success(res) {
      var _res$data2 = res.data,
        itemCount = _res$data2.itemCount,
        basketMarkup = _res$data2.basketMarkup,
        cartCount = _res$data2.cartCount,
        totalPrice = _res$data2.totalPrice;
      var buyButton = $(".products__buy[data-id=\"".concat(productId, "\"]"));
      (0,_helpers_updateBuyButton__WEBPACK_IMPORTED_MODULE_4__["default"])("delete", buyButton);
      closestCard.removeClass("loading");
...
var accessoriesWrapper = _refs__WEBPACK_IMPORTED_MODULE_0__["default"].accessoriesWrapper,
  ...
  cartCountEl = _refs__WEBPACK_IMPORTED_MODULE_0__["default"].cartCountEl,
  ...
  cardButtonPrice = _refs__WEBPACK_IMPORTED_MODULE_0__["default"].cardButtonPrice;
var _settings = settings,
  ajax_url = _settings.ajax_url;
...
var galleryMain = new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"](".gallery-main", {
  grabCursor: true,
  thumbs: {
...
var accessoriesSwiper = new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"](".accessories-swiper", {
  slidesPerView: 1,
  spaceBetween: 22,
  grabCursor: true,
  loop: true,
...
/*!*****************************!*\
  ...
  \*****************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _js_product_swiper__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../js/product/swiper */ "./assets/js/product/swiper.js");
...
/* harmony import */ var _basket_manipulations__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./basket/manipulations */ "./assets/js/basket/manipulations.js");
/* harmony import */ var _utils_hero_swiper__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./utils/hero-swiper */ "./assets/js/utils/hero-swiper.js");
/* harmony import */ var _css_basket_scss__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../css/basket.scss */ "./assets/css/basket.scss");
