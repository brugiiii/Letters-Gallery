...
/***/ "./assets/js/main/activateCategory.js":
/*!********************************************!*\
  !*** ./assets/js/main/activateCategory.js ***!
  \********************************************/
...
/* harmony import */ var _refs__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./refs */ "./assets/js/main/refs.js");
...
var gallerySection = _refs__WEBPACK_IMPORTED_MODULE_8__["default"].gallerySection,
  subMenu = _refs__WEBPACK_IMPORTED_MODULE_8__["default"].subMenu;
...
function handleButtonClick(e) {
  ...
  if (window.location.href === home_url) {
    ...
    window.location.href = "".concat(home_url, "?artistId=").concat(artistId);
  }
}
function setActiveArtist(id) {
  var filterToActive = $(".nav-list__button[data-tax-id=\"".concat(id, "\"]"));
  if (!filterToActive[0]) return;
  filterToActive.trigger("click");
  setTimeout(function () {
    gallerySection[0].scrollIntoView({
      behavior: 'smooth'
    });
  }, 0);
}
...
/***/ "./assets/js/main/activeNavLink.js":
/*!*****************************************!*\
  !*** ./assets/js/main/activeNavLink.js ***!
  \*****************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
var navLine = _refs__WEBPACK_IMPORTED_MODULE_0__["default"].navLine,
  navLinks = _refs__WEBPACK_IMPORTED_MODULE_0__["default"].navLinks;
navLinks.on("mouseleave", function () {
  return navLine.css("opacity", 0);
});
...
var burgerButtonEl = _refs__WEBPACK_IMPORTED_MODULE_2__["default"].burgerButtonEl,
  burgerMenuEl = _refs__WEBPACK_IMPORTED_MODULE_2__["default"].burgerMenuEl,
  menuButtonMob = _refs__WEBPACK_IMPORTED_MODULE_2__["default"].menuButtonMob,
  bodyEl = _refs__WEBPACK_IMPORTED_MODULE_2__["default"].bodyEl;
...
function handleButtonClick() {
  if (bodyEl.hasClass("menu-is-open")) {
    (0,_utils_utils__WEBPACK_IMPORTED_MODULE_1__.enableBodyScroll)();
    window.removeEventListener("resize", throttledHandleResize);
  } else {
    (0,_utils_utils__WEBPACK_IMPORTED_MODULE_1__.disableBodyScroll)();
...
burgerButtonEl.on("click", lodash_throttle__WEBPACK_IMPORTED_MODULE_0___default()(handleButtonClick, 250));
burgerMenuEl.on("click", "a, button:not(.nav-list__link)", handleButtonClick);

/***/ }),

/***/ "./assets/js/main/formSubmit.js":
/*!**************************************!*\
  !*** ./assets/js/main/formSubmit.js ***!
  \**************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
function handleFormSubmit(e) {
  e.preventDefault();
  var $this = $(e.currentTarget);
  var formData = Object.fromEntries(new FormData(e.currentTarget));
  var query = {
    action: "send_mail",
    formData: formData
  };
...
_refs__WEBPACK_IMPORTED_MODULE_2__["default"].footerFormEL.on("submit", handleFormSubmit);

/***/ }),

/***/ "./assets/js/main/inputMask.js":
/*!*************************************!*\
  !*** ./assets/js/main/inputMask.js ***!
  \*************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _refs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./refs */ "./assets/js/main/refs.js");
...
var masks = {};
var popupForm = _refs__WEBPACK_IMPORTED_MODULE_4__["default"].popupForm;
var telInput = popupForm.find("input[type='tel']");
var postCodeInput = popupForm.find("input[name='post_code']");
...
/* harmony import */ var _refs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./refs */ "./assets/js/main/refs.js");
/* harmony import */ var _utils_utils__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../utils/utils */ "./assets/js/utils/utils.js");
...
var hidePopupButton = _refs__WEBPACK_IMPORTED_MODULE_4__["default"].hidePopupButton,
  showPopupButton = _refs__WEBPACK_IMPORTED_MODULE_4__["default"].showPopupButton,
  popupBackdrop = _refs__WEBPACK_IMPORTED_MODULE_4__["default"].popupBackdrop,
  popupForm = _refs__WEBPACK_IMPORTED_MODULE_4__["default"].popupForm;
var _settings = settings,
  ajax_url = _settings.ajax_url;
function handleFormSubmit(e) {
  e.preventDefault();
  var $this = $(e.currentTarget);
  var telInput = $this.find('input[type="tel"]');
  var formData = Object.fromEntries(new FormData(e.currentTarget));
...
showPopupButton.on("click", function () {
  return (0,_utils_utils__WEBPACK_IMPORTED_MODULE_5__.showBackdrop)(popupBackdrop);
});
hidePopupButton.on("click", function () {
  return (0,_utils_utils__WEBPACK_IMPORTED_MODULE_5__.hideBackdrop)(popupBackdrop);
});
...
var scrollTop = _refs__WEBPACK_IMPORTED_MODULE_0__["default"].scrollTop;
...
$(window).on("scroll", lodash_throttle__WEBPACK_IMPORTED_MODULE_1___default()(scrollTopVisibility, 300));
...
function animateBackground() {
  animationFrame = requestAnimationFrame(animateBackground);
  var x = offsetX / currentTarget.offsetWidth * 100;
  var y = offsetY / currentTarget.offsetHeight * 100;
...
var bodyEl = _main_refs__WEBPACK_IMPORTED_MODULE_1__["default"].bodyEl;
var throttledHandleResize = lodash_throttle__WEBPACK_IMPORTED_MODULE_0___default()(handleResize, 200);
...
/* harmony import */ var _utils_utils__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./utils/utils */ "./assets/js/utils/utils.js");
/* harmony import */ var _main_activeNavLink__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./main/activeNavLink */ "./assets/js/main/activeNavLink.js");
/* harmony import */ var _main_scrollTop__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./main/scrollTop */ "./assets/js/main/scrollTop.js");
...
/* harmony import */ var _main_popup__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./main/popup */ "./assets/js/main/popup.js");
/* harmony import */ var _main_inputMask__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./main/inputMask */ "./assets/js/main/inputMask.js");
/* harmony import */ var _css_main_scss__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../css/main.scss */ "./assets/css/main.scss");
